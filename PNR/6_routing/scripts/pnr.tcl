...
create_fp_virtual_pad -net VSS -point {6.1320 137.8850}
create_fp_virtual_pad -net VSS -point {0.0000 565.3735}
create_fp_virtual_pad -net VSS -point {3.0660 1023.9610}
create_fp_virtual_pad -net VSS -point {95.0460 1342.8260}
create_fp_virtual_pad -net VSS -point {420.0430 1333.6280}
create_fp_virtual_pad -net VSS -point {760.3695 1339.7600}
create_fp_virtual_pad -net VSS -point {1116.0265 1336.6940}
create_fp_virtual_pad -net VSS -point {1342.9110 1232.4495}
create_fp_virtual_pad -net VSS -point {1335.8625 750.8215}
create_fp_virtual_pad -net VSS -point {1339.8450 349.4395}
create_fp_virtual_pad -net VSS -point {1260.1290 -9.2830}
create_fp_virtual_pad -net VSS -point {932.0660 -6.2170}
create_fp_virtual_pad -net VSS -point {594.8055 -3.1510}
create_fp_virtual_pad -net VSS -point {260.6105 -3.1510}
create_fp_virtual_pad -net VSS -point {323.1465 406.8000}
create_fp_virtual_pad -net VDD -point {3.0660 303.4495}
create_fp_virtual_pad -net VDD -point {6.1320 754.1525}
create_fp_virtual_pad -net VDD -point {6.1320 1201.7895}
create_fp_virtual_pad -net VDD -point {229.9505 1336.6940}
create_fp_virtual_pad -net VDD -point {576.4095 1336.6940}
create_fp_virtual_pad -net VDD -point {916.7360 1336.6940}
create_fp_virtual_pad -net VDD -point {1269.3270 1333.6280}
create_fp_virtual_pad -net VDD -point {1349.0430 1030.0930}
create_fp_virtual_pad -net VDD -point {1349.0430 576.3240}
create_fp_virtual_pad -net VDD -point {1349.0430 101.0930}
create_fp_virtual_pad -net VDD -point {1091.4985 -6.2170}
create_fp_virtual_pad -net VDD -point {766.5020 -3.1510}
create_fp_virtual_pad -net VDD -point {420.0430 -6.2170}
create_fp_virtual_pad -net VDD -point {95.0460 -6.2170}
