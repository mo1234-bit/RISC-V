module execute_cycle( input clk, rst, RegWriteE,FRegWrite_E,ALUSrcE,MemWriteE,ResultSrcE,BranchE,JumpE,
    input [3:0] ALUControlE,
    input [2:0] funct3E,
    input [6:0] OpE,  // Added opcode to distinguish JAL vs JALR
