...
module set(clk,
    ...
    input wire [29-cache_entry:0] o_tag;
    ...
    wire [29-cache_entry:0] 	 i_tag;
    wire 			             dirty;
    wire [31-cache_entry:0] 	 write_tag_data;
    ...
    simple_ram #(.width(32-cache_entry), .widthad(cache_entry)) ram_tag(clk, entry, write, write_tag_data, entry, {dirty, valid, i_tag});
    integer i;
